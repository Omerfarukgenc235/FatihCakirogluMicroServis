    ...
    public static class Config
    {
        ...
        public static IEnumerable<IdentityResource> IdentityResources =>
                   new IdentityResource[]
                   {
                       ...
                       new IdentityResource(){Name="roles",Description="Kullanıcı Rolleri",UserClaims = new []{"role"}}
                   };
        ...
        public static IEnumerable<Client> Clients =>
            new Client[]
            {
                 ...
                 new Client
                {
                    ...
                    AllowedScopes={ "basket_fullpermission","gateway_fullpermission", "payment_fullpermission", "order_fullpermission", "discount_fullpermission", IdentityServerConstants.StandardScopes.Email,IdentityServerConstants.StandardScopes.OpenId,IdentityServerConstants.StandardScopes.Profile,IdentityServerConstants.StandardScopes.OfflineAccess, IdentityServerConstants.LocalApi.ScopeName, "roles" },
